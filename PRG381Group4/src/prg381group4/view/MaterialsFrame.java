...
// REFERENCE IMPLEMENTATION (template) - placeholder stub only.
...
import prg381group4.controller.MaterialController;
...
// This hand-coded window is the template SuppliersFrame/CleanersFrame copy.
// TODO: fill in as the reference. Extends JFrame. Talks to MaterialController
//       only - never to model.dao. Use HIDE_ON_CLOSE, not DISPOSE_ON_CLOSE.

public class MaterialsFrame extends javax.swing.JPanel {

    public MaterialController matCont = new MaterialController();
    String searchItem;
    public MaterialsFrame() {
        ...
        table.addMouseListener(new MouseListener() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                txtCode.setText(table.getValueAt(table.getSelectedRow(), 1).toString());
                txtName.setText(table.getValueAt(table.getSelectedRow(), 2).toString());
                txtUnit.setText(table.getValueAt(table.getSelectedRow(), 3).toString());
                txtQuantity.setText(table.getValueAt(table.getSelectedRow(), 4).toString());
                txtReorderLvl.setText(table.getValueAt(table.getSelectedRow(), 5).toString());
                txtUnitPrice.setText(table.getValueAt(table.getSelectedRow(), 6).toString().substring(1));
                txtSupplier.setText(table.getValueAt(table.getSelectedRow(), 7).toString());
  ...
  public void clear(){
    ...
    public void add(){
        ...
        try {
            matCont.addMaterial(txtCode.getText()
                    ,txtName.getText()
                    ,txtUnit.getText()
                    ,txtQuantity.getText()
                    ,txtReorderLvl.getText()
    ...
    public void delete(){
        try {
            matCont.deleteMaterial(Integer.parseInt(lblID.getText()));
        } catch (DataAccessException ex) {
            System.out.println("Something went wrong"+ ex.getMessage());
        }
    }
    ...
    public void update(){
        try {
            matCont.updateMaterial(Integer.parseInt(lblID.getText()),txtCode.getText()
                    ,txtName.getText()
                    ,txtUnit.getText()
                    ,txtQuantity.getText()
                    ,txtReorderLvl.getText()
    ...
    public void loadTblData(){
        ...
        try {
            List<Material> data = matCont.getAllMaterials();
    ...
    private void SeachEventHandler(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_SeachEventHandler
            }//GEN-LAST:event_SeachEventHandler
